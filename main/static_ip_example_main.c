...
#define EXAMPLE_WIFI_SSID             "CF"
#define EXAMPLE_WIFI_PASS             "cf86686675"
#define EXAMPLE_MAXIMUM_RETRY         CONFIG_EXAMPLE_MAXIMUM_RETRY
#define EXAMPLE_STATIC_IP_ADDR        "192.168.2.53"
#define EXAMPLE_STATIC_NETMASK_ADDR   "255.255.252.0"
...
{
    esp_netif_t *netif_if=(esp_netif_t*)arg;
